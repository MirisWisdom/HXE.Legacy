...
{
  /**
   * Static API for inferring the path of the HCE executable on the filesystem.
   */
  public static class Detection
  {
    /**
     * Name of the HCE executable which is used in the available detection mechanisms.
     */
    private static readonly string Executable = Paths.HCE.Executable;
